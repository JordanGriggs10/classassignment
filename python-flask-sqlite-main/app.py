...
#Here are our imports/libaries from path
...
def home():
    return render_template("home.html")   #calling the home.html template which holds the html for the home page.

# Route to form used to add a new student to the database
@app.route("/enternew")
def enternew():
    return render_template("student.html")  #calls the student.html template from the template folder
